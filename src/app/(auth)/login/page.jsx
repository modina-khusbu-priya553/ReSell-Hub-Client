      ...
      <div className="relative hidden w-1/2 overflow-hidden bg-slate-900 lg:flex lg:flex-col lg:justify-between lg:p-12">
        ...
        <div className="relative z-10">
          <h2 className="text-3xl font-bold leading-tight text-white">
            Buy smart. <br /> Sell easy. <br /> Waste less.
          </h2>
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-slate-400">
            Join thousands of buyers and sellers giving pre-owned products a
            second life on ReSellHub.
          </p>
          ...
          <div className="mt-8 flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Happy Sellers</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex w-full items-center justify-center bg-white px-6 py-12 lg:w-1/2">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Log in to continue buying and selling on ReSellHub.
          </p>
